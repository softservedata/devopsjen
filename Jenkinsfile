        ...
        stage('Integration Test') {
            steps {
                script {
                    ...
                    sh -c 'java -jar target/contact.war & echo $! > pid.file | echo "start test" ; mvn failsafe:integration-test ; echo -n "***kill process #" ; cat pid.file; kill -9 $(cat pid.file) ; rm -rf pid.file ; echo "done"'
